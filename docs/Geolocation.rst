...
**3.18.6. Propiedades, atributos y especificadores**
    ...
    -   **Propiedad Principal Ubicaciones Geográficas (geoLocations) (O, 0-n):** Describa todas las posibles regiones espaciales o lugares con nombre donde se recopilaron los datos o sobre los cuáles se enfocaron los datos.
