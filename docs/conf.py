...
latex_documents = [
  (master_doc, 'OpenAIREGuidelines.tex', u'Directrices de Metadatos para Repositorios de Datos de Investigación del Ministerio de Ciencia, Tecnología e Innovación',
   u'', 'manual', True),
]
